...
- background: (optional) Set to "true" to run long-running commands (servers, watchers) in the background immediately.
Usage:
<execute_command>
...
NOTE: For long-running commands, the user can press Ctrl+B to send the command to background, or Esc to stop it.
